...
public class HWTimeFrameClient {
	...
	public HWTimeFrameClient() {
		frame = new JFrame("TimeClientFrame");
	...
	private JPanel createControlPanel() {
		...
		b_connect.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				disconnect();
				/*
				 * b_connect.setEnabled(false); b_disconnect.setEnabled(true);
				 * b_send.setEnabled(true); text.setEnabled(true);
				 */
			}
